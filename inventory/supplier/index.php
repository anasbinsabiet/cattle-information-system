    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
          <?php
          $query = $connect->prepare("SELECT * FROM `supplier` WHERE delete_status = 0");
          $query->execute();
          ...
          foreach ($result as $row) {                         
            ...
            <tr>
              ...
              <td><?php echo htmlspecialchars($row['supplier_number']) ?></td>
              <td><?php echo htmlspecialchars($row['supplier_address']) ?></td>
              <td><?php echo htmlspecialchars($row['supplier_email']) ?></td>
              <td><a href="add.php?id=<?php echo((((($row['supplier_id'] + 9954) * 777) / 100) * 2) * 1971); ?>">
