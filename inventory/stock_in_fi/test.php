          ...
          <tr>
            ...
            <td>
              <span class="table-remove"><button type="button"
                  class="badge badge-danger btn-rounded btn-sm my-0">Remove</button></span>
            </td>
          </tr>
...
<tr class="hide">
  ...
  <td>
    <span class="table-remove"><button type="button" class="badge badge-danger btn-rounded btn-sm my-0 waves-effect waves-light">Remove</button></span>
  </td>
</tr>`;
