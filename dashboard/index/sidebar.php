    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <li class="nav-item has-treeview menu-open">
          <a href="../../dashboard/index/" class="nav-link active" style="background: #2a6cb1;">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../../health_module/health_problem_type/" class="nav-link">
                    <i class="far fas fas fa-cog nav-icon"></i>
                    <p>Problem Type</p>
                  </a>
                </li>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../../food_module/food_type/" class="nav-link">
                    <i class="far fas fas fa-cog nav-icon"></i>
                    <p>Food Type</p>
                  </a>
                </li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../../cattle_module/cattle_profile/report.php" class="nav-link">
                <i class="far fa-star nav-icon"></i>
                <p>Cattle Profile Report</p>
              </a>
            </li>
          </ul>
        </li>
