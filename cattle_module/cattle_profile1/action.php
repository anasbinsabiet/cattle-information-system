...
if (isset($_POST['btn_action'])) {
  if ($_POST['btn_action'] == 'Add') {
   ...
   // if(empty(trim($_POST['electronic_ear_tag'])) || empty(trim($_POST['brand'])) || empty(trim($_POST['birth_weight'])) || empty(trim($_POST['weaning_weight'])) || empty(trim($_POST['height'])) || empty(trim($_POST['width'])) || empty(trim($_POST['length'])) || empty(trim($_POST['weight'])) || empty(trim($_POST['teeth'])) || empty(trim($_POST['special_sign'])) || empty(trim($_POST['age'])) || empty(isset($_FILES['cattle_profile_pic']))) {
