        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          foreach ($result as $row) {
            ...
            <tr>
              ...
              <td><a
                  href="view.php?id=<?php echo((((($row['cattle_profile_id'] + 9954) * 777) / 100) * 2) * 1971); ?>">
                  <button class="badge badge-success btn-sm">View</button>
                </a>
                <a href="add.php?id=<?php echo((((($row['cattle_profile_id'] + 9954) * 777) / 100) * 2) * 1971); ?>">
