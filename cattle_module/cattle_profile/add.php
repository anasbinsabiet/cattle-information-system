          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-sm-6 col-md-3 col-lg-3">
                ...
                <input type="text" onkeypress="return /[a-z]/i.test(event.key)" class="form-control" id="problem_details" name="problem_details"
                       placeholder="problem_details">
              </div>

              <div class="form-group col-sm-6 col-md-3 col-lg-3">
                <label for="problem_area">Problem Area</label>
                <select class="form-control select2" multiple="multiple" id="problem_area" name="problem_area[]">
              ...
              <!-- <div class="form-group col-sm-6 col-md-3 col-lg-3">
                ...
                <select class="form-control select2 problem_area" multiple="multiple" id="problem_area" name="problem_area[]">
                   echo filled_problem_area($connect);
                </select>
              </div> -->
              ...
              <div class="form-group col-sm-6 col-md-3 col-lg-3">
                <label for="cattle_profile_pic1">Cattle Image <!-- <span class="text-red">*</span> --></label>
